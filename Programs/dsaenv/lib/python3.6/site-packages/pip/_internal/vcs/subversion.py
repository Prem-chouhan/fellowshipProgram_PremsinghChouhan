...
class Subversion(VersionControl):
    ...
    def _get_svn_url_rev(cls, location):
        ...
        if (data.startswith('8') or
            ...
            url = match.group(1)    # get inventorymanager URL
    ...
    def export(self, location, url):
        ...
        """Export the svn inventorymanager at the url to the destination location"""
        url, rev_options = self.get_url_rev_options(url)

        logger.info('Exporting svn inventorymanager %s to %s', url, location)
        with indent_log():
