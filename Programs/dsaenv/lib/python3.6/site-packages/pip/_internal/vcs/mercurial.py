...
class Mercurial(VersionControl):
    ...
    def export(self, location, url):
        ...
        """Export the Hg inventorymanager at the url to the destination location"""
    ...
    def switch(self, dest, url, rev_options):
        ...
        try:
            ...
            logger.warning(
                'Could not switch Mercurial inventorymanager to %s: %s', url, exc,
            )
        else:
    ...
    def get_revision(cls, location):
        """
        Return the inventorymanager-local changeset revision number, as an integer.
        """
