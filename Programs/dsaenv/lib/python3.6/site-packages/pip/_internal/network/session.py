...
class PipSession(requests.Session):
    ...
    def is_secure_origin(self, location):
        ...
        # Don't count the inventorymanager type as part of the protocol: in
        ...
        logger.warning(
            "The inventorymanager located at %s is not a trusted or secure host and "
            "is being ignored. If this inventorymanager is available via HTTPS we "
