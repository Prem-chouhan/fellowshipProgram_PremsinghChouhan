...
sys.path.insert(0, '/home/admin-1/PycharmProjects/Fun/templates/')
...
class S(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if self.path == '/forgot':
            ...
            # response_data.update({"success": True, "data": [], "message": "Successfully changed password"})
